...
class Job(models.Model):
    ...
    company = models.CharField("Название компании", max_length=100)  # Исправлено название компании
    ...
    email = models.EmailField("E-mail", max_length=100)  # Используем EmailField для email
